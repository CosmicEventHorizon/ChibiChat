...
class KoboldActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kobold)
        InitializeWidgets()
        LoadData()
    ...
    fun SaveData() {
        val sharedPrefs = getSharedPreferences("saved_kobold_settings", Context.MODE_PRIVATE)
